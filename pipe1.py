...
cols='Date mutation|Nature mutation|Valeur fonciere|No voie|Type de voie|Voie|Code postal|Commune|Code departement|Code commune|Surface Carrez du 1er lot|Surface Carrez du 2eme lot|Surface Carrez du 3eme lot|Surface Carrez du 4eme lot|Surface Carrez du 5eme lot|Code type local|Type local|Nombre pieces principales|Surface terrain'.split('|')
names='date|nature|valeur|no_voie|type_voie|voie|cp|commune|code_dept|code_comm|surface1|surface2|surface3|surface4|surface5|code_type|local|pieces|terrain'.split('|')
...
df=df[df.surface_total>0.0] # ne garde que les typa 1/2/3/4
